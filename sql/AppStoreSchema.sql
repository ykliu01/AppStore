...
username VARCHAR REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
...
owner_username VARCHAR NOT NULL REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
borrower_username VARCHAR NOT NULL REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
