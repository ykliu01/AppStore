...
username VARCHAR(64) REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
...
owner_username VARCHAR(64) NOT NULL REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
borrower_username VARCHAR(64) NOT NULL REFERENCES students(username) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
